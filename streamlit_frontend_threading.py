...
def generate_thread_id():    # unique thread id generation for every new chat
...
def reset_chat():
    ...
    st.session_state['message_history'] = []   # clean everything after refreshing the page
...
if 'thread_id' not in st.session_state:     # if no thread id present then call the function ->create thread_id ->save in session 
